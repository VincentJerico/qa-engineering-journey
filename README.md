...
3. **API Testing** — request/response validation, contract testing
4. **Automation** — UI (Selenium/Playwright) and API test automation
...
Empty folders contain a `.gitkeep` placeholder so the structure is preserved in version control. Replace these as content is added.
